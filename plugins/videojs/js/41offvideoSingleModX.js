...
$("#negative3L").click(function() { // button function for rewind
    ...
    rewind = setInterval(function() {
      ...
      setTimeout(function() {
        ...
        var video_directory = ['https://www.dropbox.com/s/mwiclmv2yhbe6p7/JM-08-27-2022-10.75.mp4?raw=1',
                               'https://www.dropbox.com/s/f5jo173toqm9w4k/XJM-05-19-2022-2k.mp4?raw=1',
